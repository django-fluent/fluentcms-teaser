...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('contentitem_fluentcms_teaser_teaseritem', 'url_title',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('contentitem_fluentcms_teaser_teaseritem', 'url_title')
    ...
    models = {
        ...
        'fluent_contents.contentitem': {
            ...
            'placeholder': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'contentitems'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['fluent_contents.Placeholder']"}),
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'polymorphic_fluent_contents.contentitem_set+'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
        ...
        'fluentcms_teaser.teaseritem': {
            'Meta': {'ordering': "(u'placeholder', u'sort_order')", 'object_name': 'TeaserItem', 'db_table': "u'contentitem_fluentcms_teaser_teaseritem'", '_ormbases': ['fluent_contents.ContentItem']},
