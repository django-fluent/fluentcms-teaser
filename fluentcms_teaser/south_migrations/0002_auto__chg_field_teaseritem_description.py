...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeaserItem.description'
        db.alter_column('contentitem_fluentcms_teaser_teaseritem', 'description', self.gf('fluent_contents.extensions.PluginHtmlField')(null=True))

    def backwards(self, orm):

        # Changing field 'TeaserItem.description'
        db.alter_column('contentitem_fluentcms_teaser_teaseritem', 'description', self.gf('django.db.models.fields.TextField')(null=True))
